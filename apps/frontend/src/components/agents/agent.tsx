...
import { InsertMediaIcon } from '@gitroom/frontend/components/ui/icons';
        ...
        toolBar={
          onCreateCarousel ? (
            <button
              ...
              className="cursor-pointer disabled:cursor-not-allowed disabled:opacity-45 h-[30px] rounded-[6px] justify-center items-center flex bg-newColColor px-[8px]"
            >
              <span className="flex gap-[6px] items-center">
                <InsertMediaIcon size={16} />
