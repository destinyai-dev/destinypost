...
const PROVIDERS: ProviderConfig[] = [
  {
    provider: 'canva',
    label: 'Canva',
    iconUrl: '/icons/third-party/canva.svg',
    fields: [
      {
        key: 'clientId',
        label: 'Client ID',
        placeholder: 'Cole o Client ID da integracao Canva',
      },
      {
        key: 'clientSecret',
        label: 'Client Secret',
        placeholder: 'Cole o Client Secret da integracao Canva',
      },
    ],
    docsUrl: 'https://www.canva.dev/docs/connect/',
    callbackPaths: [
      { path: '/api/third-party/canva/oauth/callback' },
    ],
  },
  {
    provider: 'pexels',
    label: 'Pexels',
    iconUrl: '/icons/third-party/stock-photos.svg',
    fields: [
      {
        key: 'apiKey',
        label: 'API Key',
        placeholder: 'Cole a chave da API Pexels',
      },
    ],
  ...
  },
  {
    provider: 'polotno',
    label: 'Polotno',
    iconUrl: '/icons/third-party/design-editor.svg',
    fields: [
      {
        key: 'apiKey',
        label: 'License Key',
        placeholder: 'Cole a chave de licença do editor Polotno',
      },
    ],
    docsUrl: 'https://polotno.com/cabinet/',
  },
  {
    provider: 'tiktok',
    label: 'TikTok',
